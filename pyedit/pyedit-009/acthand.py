...
#       This is a very desirble behavior when writing code, as it feeds the 
...
#       If token completion filled in unwanted string, backpedal to the half 
#       point in the string and type as usual.
#       If the completion behaviour is not desired, disable the code marked
#       "Token Completion"
#
...
class ActHand:
    ...
    # Cut to clipboard
    def ctrl_x(self, self2, fake = False):
        xidx = self2.caret[0] + self2.xpos; 
        yidx = self2.caret[1] + self2.ypos 
        print "CTRL - X"                 
    ...
    # Tab handle is awkward. The regular tab will insert four spaces
