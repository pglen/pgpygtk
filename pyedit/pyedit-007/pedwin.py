...
class EdMainWindow():
    ...
    def __init__(self, fname, parent, names):
        ...
        #merge.add_ui(merge_id, "/MenuBar/FileMenu/", "Test", "Test", gtk.UI_MANAGER_MENUITEM, True)
        #merge.add_ui(merge_id, "ui/MenuBar/File/", "Test", "Test", gtk.UI_MANAGER_SEPARATOR, True)
