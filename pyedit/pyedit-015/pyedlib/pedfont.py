...
def selfont(self, self2):
    ...
    dialog.tree.connect("cursor-changed",  tree_sel_row, dialog)
    ...
    dialog.tree3.connect("cursor-changed",  tree_sel_row3, dialog)
...
def tree_sel_row2(xtree, dialog):
...
def tree_sel_row3(xtree, dialog):
