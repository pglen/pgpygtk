...
class KeyHand:
    ...
    def __init__(self):
        ...
        self.ctrl_keytab = [
            [gtk.keysyms.Tab, self.act.ctrl_tab],
            [gtk.keysyms.Up, self.act.up],
            [gtk.keysyms.KP_Up, self.act.up],
            [gtk.keysyms.Down, self.act.down],
            [gtk.keysyms.KP_Down, self.act.down],
            ...
            [gtk.keysyms.Z, self.act.ctrl_z],
            [gtk.keysyms._1, self.act.ctrl_1],
            [gtk.keysyms._2, self.act.ctrl_2],
            [gtk.keysyms._3, self.act.ctrl_3],
            [gtk.keysyms._4, self.act.ctrl_4],
            [gtk.keysyms._5, self.act.ctrl_5],
            [gtk.keysyms._6, self.act.ctrl_6],
            [gtk.keysyms._7, self.act.ctrl_7],
            [gtk.keysyms._8, self.act.ctrl_8],
            [gtk.keysyms._9, self.act.ctrl_9],
            [gtk.keysyms._0, self.act.ctrl_0],
