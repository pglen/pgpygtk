...
class PubView(gtk.Window):
    ...
    def OnExit(self, arg):
        ...
        #print "lastrun", last
        self.conf.sql.put("lastrun", last + 1)      
        iter = self.buffer_1.get_iter_at_mark(self.buffer_1.get_insert())
        #print "Saving last:", self.fname, iter.get_offset()
        self.conf.sql.put(self.fname, iter.get_offset())      
        #print "Saving lastsel:", self.conf.basefile, self.lastsel
        self.conf.sql.put(self.conf.basefile, self.lastsel)
        #print "Saving lastfile:", self.conf.basefile + "_init", self.fname
        self.conf.sql.put(self.conf.basefile + "_init", self.fname)
