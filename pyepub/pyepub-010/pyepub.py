...
from    pubparse import TocHTMLParser, OpfHTMLParser
from    pubparse import  HTML_Recurse, RootHTMLParser
...
def readepub(zf):
    ...
    # Hack: to simplify parsing we search for an .ncx file
    if not found: 
        for aa in allnames:
            if ".ncx" in aa:
                #print "Found toc", aa
...
def phelp():
    ...
    print "            -d level  - Debug messages (limited implementation)"
