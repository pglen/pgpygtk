...
class img_main(gtk.DrawingArea):
    ...
    def expose(self, area, a3):
        ...
        for xx, yy, col in self.aframe:
            ...
            #winn.draw_line(gcr, xx*self.stepx, yy*self.stepy,
    ...
    def anal_image(self, xxx = -1, yyy = -1):
        ...
        # Set up flood fill
        fparm = floodParm(self.divider);
        fparm.darr  = darr;              fparm.mark = darr[xxx][yyy]
        fparm.hstep = hstep;             fparm.vstep = vstep
        fparm.ddd   = self.divider;      fparm.tresh = 30               
        ...
        # Reference position
        #imgrec.frame(xxx * hstep, yyy * vstep, (xxx+1)*hstep, (yyy+1)*vstep, 0xff8888ff)
