...
class VrPlot(gtk.DrawingArea):
    ...
    def area_expose_cb(self, area, event):
        ...
        self.gcx.set_foreground(colormap.alloc_color("#ffffff"))
        self.gcx.set_foreground(colormap.alloc_color("#eeeeee"))
    ...
    def area_motion(self, area, event):    
        ...
        if event.state & gtk.gdk.BUTTON1_MASK:            
            ...
            gcx.set_foreground(colormap.alloc_color("#ffffff"))
            ...
            if  clen > 1:
                ...
                #self.drawpad.draw_line(gcr, xx, yy, xx2, yy2)
    ...
    def plotcolor(self, color_str):
        colormap = gtk.widget_get_default_colormap()        
        self.gc.set_foreground(colormap.alloc_color(color_str))
    ...
    # --------------------------------------------------------------------
    # Draw an oscilloscope like line on the widget with scrolling
    ...
    def plotline2(self, yy):
        ...
        # Scroll
        if self.virt_x >= ww:
            # Make a copy, clean, shift
            self.drawpad2.draw_drawable(self.gcx, self.drawpad, \
                                            0, 0, 0, 0, ww, hh)
            self.drawpad.draw_rectangle(self.gcx, True, 0, 0, ww, hh)
            self.drawpad.draw_drawable(self.gcx, self.drawpad2, \
                                            scr, 0, 0, 0, ww-scr, hh)
            self.draw_grid()
            self.virt_x = ww - scr; 
            
        xx = self.virt_x;  xx2 = self.virt_x + 1
        self.drawpad.draw_line(self.gc, xx, yy, xx2, yy2)
