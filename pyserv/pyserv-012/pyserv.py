...
import pyserv.pystate, pyserv.pydata
...
class ThreadedTCPRequestHandler(SocketServer.BaseRequestHandler):
    ...
    def setup(self):
        ...
        self.datahandler = pyserv.pydata.DataHandler()
        self.datahandler.verbose = verbose
        self.statehandler = pyserv.pystate.StateHandler(self)
    ...
    def handle_error(request, client_address):
        print  "Error", request, client_address
