...
#
# How it works: We create pylons from rectangles. (rects are created 
# from triangs) The pylon is added to a pylon array, and the pylonarr is 
# added to the font dict. The dict can draw the font at current location with
# the draw() function.
#
...
class GlFont():
    ...
    def print3Dstr(self, xstr):
        increment = 0
        for chh in xstr:
            dist = self.print3Dchar(chh)
