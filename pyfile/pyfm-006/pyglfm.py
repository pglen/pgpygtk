...
class GLfileMan (object):
    ...
    def initfonts(self):
        ...
        self.font   = GlFont(1., UpperCase(), LowerCase(), NumPunc())
        self.font.setdepth(-.2)
        self.font.setfontcolor([ 0.729412, 0.723529, 0.727451, 1.0 ])
        
        self.fontb  = GlFont(1., UpperCase(), LowerCase(), NumPunc())
        self.fontb.setfontcolor([ 0.929412, 0.023529, 0.927451, 1.0 ])
       
        self.font2  = GlFont(.5, UpperCase(), LowerCase(), NumPunc())
        
        self.font2s  = GlFont(.5, UpperCase(), LowerCase(), NumPunc())
        self.font2s.setfontcolor([ 0.929412, 0.023529, 0.927451, 1.0 ])
        self.font2s.fatfont(.6)
        
        self.font4  = GlFont(.25, UpperCase(), LowerCase(), NumPunc())
