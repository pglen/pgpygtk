...
def stuff(self):
    ...
    glTranslatef (hoffset, offset, 0)
    self.font2s.print3Dstr("xyz123456ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    glPopMatrix ()
    
    glPushMatrix ()
    offset -= self.font.FontHeight  + self.font.linegap
    glTranslatef (hoffset, offset, 0)
    self.font.print3Dstr("xyz123456ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    glPopMatrix ()
    
    #print self.font.extent3Dstr("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
