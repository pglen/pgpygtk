...
class GLfileMan (object):
    ...
    def inittextpads(self):
        self.textpad = TextPad(self, self.font12, 2, 0, 1)
        self.textpad.addtext("Hello")        
        self.textpad.addtext("Hello2")        
        self.textpad.addtext("/usr/share/pixmaps/cupsprinter.png")        
        self.textpad.addtext("Hello3 is here")        
        self.textpad.addtext("Hello3 is here")        
        self.textpad.addtext("Hello3 is here")        
        self.textpad.addtext("/usr/share/pixmaps/gdm-foot-logo.png")        
    ...
    def renderscene(self, showall = False ):
        ...
        if  0: #self.anicount < 40:
            ...
            try:
                ...
                self.textpad.draw(self.pos_y, self.angle)
