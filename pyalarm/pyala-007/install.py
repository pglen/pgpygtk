...
import time, sys, os, re, stat, subprocess, pwd
...
try:
    # Swap twice for no effect, this assumes we where root
    ...
    print "Warning! SUID funtionality not available. Upgrade to Pyhon 2.7"\
           "or later"
