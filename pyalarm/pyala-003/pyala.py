...
import random, stat, subprocess, gobject

import pyala.pyalawin as pyalawin
import rtc.rtc as rtc

from pyala.pgutil import  *
...
if __name__ == '__main__':
    ...
    mw = pyalawin.MainWin(rtcflag); mw.app_tick = app_tick
