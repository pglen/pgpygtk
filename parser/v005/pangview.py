...
parser.parsetable = \
         ...
         [ None,    STATEFMT,     "lmargin",   None,  Lmargin,    parser.LMARGIN, 0 ],     \
         [ None,    STATEFMT,     "hid",      None,   Hid,        parser.HID, 0 ],        \
         [ None,    STATEFMT,     "ncol",     None,   Ncol,       parser.NCOL, 0 ],       \
         [ None,    STATEFMT,     "ncol2",     None,  Ncol2,       parser.NCOL, 0 ],       \
         ...
         [ parser.VAL,    None,   "str4",     None,     Keyval,   parser.IGNORE, 0 ],     \
         ...
         [ parser.SPANTXT, None,  "elink",    None,     eLink,      parser.IGNORE, 0 ],            \
                                                                                          \
         ...
         [ parser.LMARGIN,     None,  "elmargin",    None,   eLmargin,  parser.IGNORE, 0 ],       \
                                                                                                \
...
if __name__ == "__main__":
    ...
    mainview = pangodisp.PangoView(full=full_screen)
